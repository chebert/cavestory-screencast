#ifndef COMPOSITE_COLLISION_RECTANGLE_H_
#define COMPOSITE_COLLISION_RECTANGLE_H_

#include <assert.h>

#include "collision_rectangle.h"

struct CompositeCollisionRectangle : CollisionRectangle {
...
#endif // COMPOSITE_COLLISION_RECTANGLE_H_